...
const Navbar = () => {
  ...
  return (
    <header className="relative z-50 px-[60px] max-sm:px-[30px]">
      ...
      <div className="flex items-center ml-28 shrink max-sm:hidden gap-7 border-slim border-main rounded-[30px] p-1 pl-1 pr-8">
      ...
      {/* Mobile Nav */}
    {
      navOpen && (
        ...
        <div className="flex flex-col items-end p-8 pr-16 space-y-4 -ml-[30px] -mt-[20px] text-[#010303] bg-[#f5f5f5] rounded-md">
          ...
          <a href="#services" className="text-3xl font-medium">Service</a>
          <a href="#about" className="text-3xl font-medium">About Us</a>
          <a href="#projects" className="text-3xl font-medium">Project</a>
