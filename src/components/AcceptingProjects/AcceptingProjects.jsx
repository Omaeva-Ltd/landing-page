...
import Calendely from "../Calendely/Calendely";
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 max-md:mb-10">
      <div className=" flex text-center flex-col justify-center items-center">
        ...
        <a href="#appointment">
          <ShimmerButton background="#800080" className="m-5" >Book an Appointment</ShimmerButton>
        </a>
        {/* <div className="mt-10 bg-main rounded-full py-3 px-6 text-white font-medium"><Calendely /></div> */}
